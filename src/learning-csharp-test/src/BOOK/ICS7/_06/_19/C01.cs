...
namespace LT.TEST.BOOK.ICS7._06._19
{
    public class C01
    {
        ...
        public void _01()
        {
            ...
            //----------------------------------------------------------------------------------------------------
            Assert.Equal(6, LT.LIB.BOOK.ICS7._06._19.C01.Fn01(1, 2, 3));
            ...
            //----------------------------------------------------------------------------------------------------
            int[] arr01 = { 1, 2, 3 };
            Assert.Equal(12, LT.LIB.BOOK.ICS7._06._19.C01.Fn01(y: 2, x: 1, arr: arr01, z: 3));

            //----------------------------------------------------------------------------------------------------
            // 混合使用 positional parameter 和 named parameter，所有的 positional parameter 必须在前面
            //----------------------------------------------------------------------------------------------------
            Assert.Equal(12, LT.LIB.BOOK.ICS7._06._19.C01.Fn01(1, z: 3, arr: arr01, y: 2));
        }
    }
}
